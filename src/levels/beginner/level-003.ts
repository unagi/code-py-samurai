...
const level003: LevelDefinition = {
  ...
  timeBonus: 35,
  aceScore: 71,
  floor: { width: 9, height: 1 },
  stairs: [8, 0],
  warrior: {
    x: 0,
    y: 0,
    direction: "east",
    abilities: ["health", "rest!"],
  },
  units: [
    { type: "sludge", x: 2, y: 0, direction: "west" },
    { type: "sludge", x: 4, y: 0, direction: "west" },
    { type: "sludge", x: 5, y: 0, direction: "west" },
    { type: "sludge", x: 7, y: 0, direction: "west" },
  ],
};
